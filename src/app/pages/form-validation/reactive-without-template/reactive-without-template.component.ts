...
import {
  AbstractControl, Form, FormGroup,
...
@Component({
  ...
  templateUrl: './reactive-without-template.html',
  styleUrl: './reactive-without-template.css'
})
export class ReactiveWithoutTemplateComponent {
